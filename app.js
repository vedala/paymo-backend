...
import { getWelcome, getBanks, getRecipients, getUserByEmail, createLinkToken, exchangePublicToken, generateTosToken, sendMoney } from "./handlers.js";
...
const port = 3000;
app.use("/", router);
routes(router, { getWelcome, getBanks, getRecipients, getUserByEmail, createLinkToken, exchangePublicToken, generateTosToken, sendMoney });
